...
**Output:** Wireframe delivered inline, also saved to `projects/[Recursos][Producto]Nombre/prototypes/[feature]-napkin-sketch.md`
...
|--------|-------|-----------------|
| Active PRD | `projects/*.md`, `projects/*.md` | UI requirements, user flows, feature scope, non-goals (what NOT to design) |
| User Research | `projects/[Recursos][Producto]Nombre/research.md` | Pain points to solve, user quotes about current UX frustrations |
| Stakeholder Profiles | `context/MY-TEAM.md` | Designer preferences (e.g., Lisa wants accessibility-first), exec priorities |
| Design System | Any design docs or style references in workspace | Colors, component patterns, layout conventions to follow |
| Past Prototypes | `projects/[Recursos][Producto]Nombre/prototypes/*.md` | Existing wireframes for consistency, decisions already made |
| Business Context | `context/MY-COMPANY.md` | Product type, user personas, platform (web/mobile/both) |
